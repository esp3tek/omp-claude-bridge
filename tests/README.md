...
| `unit-context-window.mjs` | Exact model selection; registration/execution consistency for every known family across window, plan and extra-usage settings; unsupported suffixes and restored discovered-model caches |
